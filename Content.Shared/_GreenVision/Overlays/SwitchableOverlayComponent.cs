...
namespace Content.Shared._GreenVision.Overlays;
...
public abstract partial class SwitchableOverlayComponent : BaseOverlayComponent
{
    ...
    public virtual SoundSpecifier? ActivateSound { get; set; } =
        new SoundPathSpecifier("/Audio/_GreenVision/Items/Goggles/activate.ogg");

    [DataField]
    public virtual SoundSpecifier? DeactivateSound { get; set; } =
        new SoundPathSpecifier("/Audio/_GreenVision/Items/Goggles/deactivate.ogg");
    [DataField]
