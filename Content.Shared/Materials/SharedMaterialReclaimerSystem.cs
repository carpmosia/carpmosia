...
/// <summary>
/// Carpmosia-edit - raised on a Reclaimer when it finishes reclaiming an recipe.
/// </summary>
/// <param name="Item">Item Reclaimed</param>
[ByRefEvent]
public record struct ReclaimFinishedEvent(EntityUid Item); // Carpmosia-edit - Salvage Tickets
