...
using Content.Client.Popups; // Carpmosia-edit - Label suggestions
...
using Content.Shared.Popups; // Carpmosia-edit - Label suggestions
...
public sealed partial class GuideReagentEmbed : BoxContainer, IDocumentTag, ISearchableControl, IPrototypeRepresentationControl
{
    ...
    [Dependency] private readonly IClipboardManager _clipboard = default!; // Carpmosia-edit - Label suggestions
