...
internal sealed class MappingMenuCommand : LocalizedEntityCommands
{
    ...
    public override string Command => "mappingmenu";
    ...
    public override void Execute(IConsoleShell shell, string argStr, string[] args)
    {
        ...
        //_actionSystem.LoadActionAssignments("/_Carpmosia/mapping_actions.yml", false); // Carpmosia-edit - mappingclientsidesetup fixes
    }
}
